...
//			// for (int i = 0; i < k; i++)
//			// Centroids.add(new Point(Double.valueOf(splits[0]),
...
//	}
//
//	public static class KmeansReducer extends Reducer<Point, Point, Text, Text> {
//		private final List<Point> Centroids = new ArrayList<Point>();
//
...
//					newCentroid = value;
//				else
//					newCentroid = new Point(newCentroid.getPoint().getX() + value.getPoint().getX(),
//							newCentroid.getPoint().getY() + value.getPoint().getY());
//			}
//			// on ajoute les nouveaux centroids
//			// diviser sur les centroids
//
//			newCentroid = new Point(newCentroid.getPoint().getX() / ListPoint.size(),
//					newCentroid.getPoint().getY() / ListPoint.size());
//			Centroids.add(newCentroid);
//
//			for (Point point : ListPoint) {
//				context.write(new Text(newCentroid.toString()), new Text(point.toString()));
//			}
//			// context.write(key, result);
//		}
//
//		@Override
//		protected void cleanup(Reducer<Point, Point, Text, Text>.Context context)
//				throws IOException, InterruptedException {
...
//		Path relai = new Path("relai");
//		conf.set("Centroid", relai.toString());
